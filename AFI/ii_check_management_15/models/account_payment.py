...
class RegisterPayment(models.TransientModel,):
    ...
    def _create_payment_vals_from_wizard(self):
        res = super(RegisterPayment, self)._create_payment_vals_from_wizard()
        res.update({'Check_no': self.Check_no, 'check_date':self.check_date})
        return res
        ...
        for pay in self:
            ...
            if not pay.currency_id or not pay.id:
                ...
                if pay.journal_id.default_account_id and pay.journal_id.default_account_id in liquidity_lines.account_id:
                    ...
                    pay.is_matched = True
                elif pay.payment_method_code == 'check_printing':
                    pay.is_matched = True
                else:
